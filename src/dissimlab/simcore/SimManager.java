...
//	}
	...
	public void restartSimulation(double currentSimTime)
		...
		if (controlState == SimProcessStatus.IDLE) {
			...
			//throw new SimControlException("ConcurrentSimulation already started");
			System.err.println("ConcurrentSimulation already started");
		...
		if (controlState == SimProcessStatus.IDLE) {	
			mainloop: while (currentSimTime <= endSimTime && controlState != SimProcessStatus.STOPPED) {
				...
				case IDLE:
					...
					System.out.println(simTime()+": SimModel: ConcurrentSimulation run");
					//
				...
				case RESUMED:
					controlState = SimProcessStatus.RUNNING;
					System.out.println(simTime()+": SimModel: ConcurrentSimulation rerun after pause");
					if (simMode == SimMode.ASTRONOMICAL){
				...
				case WAITINGFORSTOP:					
					...
					System.out.println(simTime()+": SimModel: ConcurrentSimulation stopped");
					break;
...
//			System.out.println("ConcurrentSimulation ended");
		} else
			//throw new SimControlException("ConcurrentSimulation already started");
			System.err.println("ConcurrentSimulation already started");
	}
